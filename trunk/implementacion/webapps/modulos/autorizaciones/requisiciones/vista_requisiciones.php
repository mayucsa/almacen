...
<!-- <div ng-controller="vistaRequisicion"> -->
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
              <h1><i class="fas fa-check"></i> Autorizaci&oacute;n requisici&oacute;n</h1>
              <!-- <p>Mayucsa / Mayamat</p> -->
            </div>
            <ul class="app-breadcrumb breadcrumb">
              <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
              <li class="breadcrumb-item"><a href="vista_requisiciones.php">Autorizaci&oacute;n</a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <!-- <div class="card card-info"> -->
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover w-100 shadow" id="tablaAutoReq">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Folio Odc</th>
...
?>
    ...
    <script src="vista_requisiciones.js"></script>
