    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="inputnombrectg" name="inputnombrectg" required="" >
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="message-text" class="col-form-label">¿Desea eliminar la siguiente Categoria?</label>
          <input type="text" class="form-control" id="inputnombrectge" name="inputnombrectge" required="" disabled>
        </div>
          <label hidden for="message-text" class="col-form-label">Usuario:</label>
