<?php
    ...
    include_once "modelo_departamentos.php";
?>
         <head>
            <!-- <title>Grupos</title> -->
...
<div class="modal fade" id="modalMensajes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-top:10%; overflow-y:visible;" >
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fas fa-boxes"></i> Departamentos</h1>
          <!-- <p>Mayucsa / Mayamat</p> -->
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="vista_departamentos.php">Departamentos</a></li>
        </ul>
      </div>
                ...
                <div class="card-body">
                    <div class="row form-group form-group-sm">
                        <div class="col-lg-12 d-lg-flex">
                            ...
                            <div style="width: 25%;" class="form-floating mx-1">
                                <input type="text" id="inputnamedepto" name="inputnamedepto" class="form-control form-control-md UpperCase">
                                ...
                                <select class="form-control form-group-md" id="selectareas" name="selectareas" hidden>
                                    ...
                                    <?php   
                                        $sql        = ModeloDepto::showAreas();
                                            ...
                                            echo '<option value="'.$value["cve_area"].'">'.$value["nombre_area"].'</option>';
                                            }
                                        ?>
                                </select>
...
<script src="vista_departamentos.js"></script>
