  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="message-text" class="col-form-label">¿Desea eliminar el siguiente Grupo?</label>
          <input type="text" class="form-control" id="inputnombregpoe" name="inputnombregpoe" required="" disabled>
        </div>
          <label hidden for="message-text" class="col-form-label">Usuario:</label>
